    ...
    <div class="sidebar pb-4 mb-4">
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-edit_Course nav-view_Course">
          ...
          <li class="nav-item">
                <a href="./index.php?page=Assignment_list" class="nav-link nav-Assignment_list">
                  <i class="fas fa-Assignments nav-icon"></i>
                  <p>Assignment</p>
                </a>
          </li>
          <?php if($_SESSION['login_type'] != 3): ?>
