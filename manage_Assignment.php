...
if(isset($_GET['id'])){
	$qry = $conn->query("SELECT * FROM Assignment_list where id = ".$_GET['id'])->fetch_array();
	foreach($qry as $k => $v){
		$$k = $v;
	}
}
...
<div class="container-fluid">
	<form action="" id="manage-Assignment">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control form-control-sm" name="Assignment" value="<?php echo isset($Assignment) ? $Assignment : '' ?>" required>
		</div>
		<div class="form-group">
